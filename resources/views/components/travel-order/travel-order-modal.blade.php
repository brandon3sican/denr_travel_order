    ...
    <div class="flex min-h-screen items-center justify-center p-4 pt-10 pb-20 text-center sm:block sm:p-0">
        ...
        <div
            ...
            <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                ...
                <button type="button" onclick="viewAttachments()"
                    class="hidden inline-flex w-full justify-center rounded-md border border-transparent bg-blue-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm">
                    <i class="fas fa-file mr-2"></i> View Attachments
                </button>
                <button type="button" onclick="closeOrderModal()"
                ...
                <table style="margin-right: auto; margin-left: auto; margin-bottom: 0pt; padding: 0pt; border-collapse: collapse; width: 100%;">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="width:82.7pt; padding:0pt 5.4pt; vertical-align:top;">
                                <p style="margin-bottom:0pt; text-align:center; line-height:normal; font-size:10pt;"><span style="font-family:'Times New Roman';">No. ${order.travel_order_number?.travel_order_number ? (order.travel_order_number.is_confirmed === 1 || order.travel_order_number.is_confirmed === true ? order.travel_order_number.travel_order_number : order.travel_order_number.travel_order_number + ' (temporary)') : 'N/A'}</span></p>
                            </td>
                            <td style="width:82.7pt; padding:0pt 5.4pt; vertical-align:top;">
                                <p style="margin-bottom:0pt; line-height:normal; font-size:10pt;"><span style="font-family:'Times New Roman';">&nbsp;</span></p>
                            </td>
                ...
                <table style="margin-right: auto; margin-left: auto; margin-bottom: 0pt; padding: 0pt; border-collapse: collapse; width: 100%;">
                    <tbody>
                        <tr style="height:12.6pt;">
                            ...
                            <td colspan="5" style="width:146.7pt; border-bottom:0.75pt solid #000000; padding:0pt 5.4pt; vertical-align:top;">
                        ...
                        <tr style="height:13pt;">
                            ...
                            <td colspan="5" style="width:146.7pt; border-top:0.75pt solid #000000; border-bottom:0.75pt solid #000000; padding:0pt 5.4pt; vertical-align:top;">
                        ...
                        <tr style="height:12.6pt;">
                            ...
                            <td colspan="5" style="width:218.95pt; border-bottom:0.75pt solid #000000; padding:0pt 5.4pt; vertical-align:top;">
                        ...
                        <tr style="height:15.75pt;">
                            ...
                            <td style="width:173.7pt; border-bottom:0.75pt solid #000000; padding:0pt 5.4pt; vertical-align:top;">
                                <div style="text-align: center;">
                                    ${order.travel_order_number?.is_confirmed === 1 || order.travel_order_number?.is_confirmed === true ? 
                        ...
                        <tr>
                            ...
                            <td style="width:145.05pt; border-bottom:0.75pt solid #000000; padding:0pt 5.4pt; vertical-align:top;">
                                <div class="text-center">
                                    ${(order.travel_order_number?.is_confirmed === 1 || order.travel_order_number?.is_confirmed === true) && order.employee?.signature?.signature_url ? 
