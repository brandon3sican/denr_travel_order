                    ...
                    <div class="bg-gray-50 p-4 rounded-md border border-gray-200">
                        ...
                        <div class="grid grid-cols-5 gap-1">
                            <div>
                                ...
                                <p class="font-medium text-gray-800">{{ auth()->user()->employee->first_name ?? '' }} {{ auth()->user()->employee->middle_name ?? '' }} {{ auth()->user()->employee->last_name ?? '' }} {{ auth()->user()->employee->suffix ?? '' }}</p>
                            </div>
                            <div>
