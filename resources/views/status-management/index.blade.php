...
<div class="flex-1 flex flex-col overflow-hidden">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-800">
                        <tr>
                            <th class="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Status Name</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50" id="status-{{ $status->id }}">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <button onclick="editStatus({{ $status->id }}, '{{ $status->name }}')" class="text-blue-600 hover:text-blue-900 mr-4">
    ...
    <div id="deleteModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
        <div class="bg-white rounded-lg shadow-xl w-full max-w-md">
            ...
            <div class="p-6">
                <p class="text-gray-700 mb-6">Are you sure you want to delete this status? This action cannot be undone.</p>
