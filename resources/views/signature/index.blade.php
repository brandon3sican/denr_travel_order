...
@section('content')
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <main class="flex-1 overflow-y-auto p-6">
                    ...
                    <div class="p-4">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <div class="bg-gray-50 p-6 rounded-lg border border-gray-200">
                                ...
                                <p class="text-sm text-gray-500 mb-4">Draw your signature using your mouse or touch screen
                                </p>

                                <div
                                    class="border-2 border-dashed border-gray-300 rounded-lg overflow-hidden mb-4 bg-white">
            ...
            @endif
            @if (isset($signature) && $signature)
                <!-- View-only Signature Modal Overlay -->
                <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" role="dialog"
                    aria-modal="true" aria-labelledby="userSigTitle">
                    <div class="bg-white rounded-xl shadow-2xl w-11/12 md:w-3/4 lg:w-1/2 max-w-3xl">
                        <div class="px-6 py-4 border-b bg-gray-100 rounded-t-xl">
                            <h3 id="userSigTitle" class="text-lg font-semibold text-gray-800 flex items-center">
                        ...
                        <div class="p-6">
                            <div class="flex justify-center">
                                <div class="inline-block bg-white p-4 border border-gray-300 rounded-lg shadow-sm">
                                    <img src="{{ $signature->signature_data }}" alt="Your Signature" class="h-24" />
                                </div>
                            </div>
                            <p class="mt-4 text-sm text-gray-600 text-center">Last updated:
                                {{ $signature->updated_at->format('M d, Y \a\t h:i A') }}</p>
                            <div class="mt-6 bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded">
                                <p class="text-sm text-yellow-800"><strong>Note:</strong> To protect the integrity
                                    of approvals and audit trails, changes to your signature are restricted. If you
                                    need to update your signature, please contact the system administrator.</p>
                            </div>
                            <div class="mt-6 text-center">
                                <a href="{{ route('dashboard') }}"
                                    class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 rounded">Close</a>
                            </div>
                        </div>
                    </div>
                </div>
